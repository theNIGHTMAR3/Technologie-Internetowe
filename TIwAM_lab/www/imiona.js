export default {
	...
	methods: {
		...
		async load() {
			const url = "imiona.php?filter=" + this.filter;
        ...
        <table class="table table-light table-striped table-sm table-hover">
            <thead>
                <tr class="table-primary">
                    ...
                    <th @click="setSort('imie')" class="text-center">Imię</th>
